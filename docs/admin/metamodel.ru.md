...
Оценка **качества данных** карточки — это взвешенная мера её полноты. Каждый влияющий фактор — каждое поле и четыре встроенных фактора — настраивается в одном месте: на панели **Качество данных** в редакторе типа карточки.
...
Полоса **состава оценки** вверху панели показывает долю каждого фактора в максимально возможной оценке, чтобы сразу видеть, какие факторы преобладают. В редакторе макета выше каждое поле также показывает небольшой значок с текущим номером уровня.
