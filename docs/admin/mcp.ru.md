...
Сервер предоставляет 26 инструментов только для чтения, сгруппированных в шесть кластеров.
...
**GRC — Безопасность и соответствие**

| Инструмент | Описание |
|------------|----------|
| `list_cve_findings` | Находки CVE с фильтрами по серьёзности / вероятности / статусу |
| `list_compliance_findings` | Находки соответствия, сгруппированные по регулятиве |
| `get_security_overview` | KPI + матрица рисков + топ критических находок |
