...
Кнопка **Импорт** рядом с «Экспортом» массово загружает риски из файла `.xlsx`. Нажмите **Скачать шаблон**, чтобы получить стартовую книгу с правильными заголовками, заполните по одному риску в строке и загрузите файл. Каждая строка создаёт **совершенно новый** риск с автоматически сгенерированной ссылкой `R-NNNNNN` — любой столбец со ссылкой в файле игнорируется (импорт никогда не обновляет существующие риски).
