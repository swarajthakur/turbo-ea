...
`SEED_DEMO=true` наполняет вкладку курированным набором примеров CVE- и комплаенс-находок (по всем шести встроенным регулятивам и с разнообразием состояний жизненного цикла) на демо-карточках NexaTech — вкладка пригодна к использованию сразу, без настройки ИИ-провайдера.
